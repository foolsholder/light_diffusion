...
HYDRA_FULL_ERROR=1 python3 utils/train.py \
    project=cross_attention exp_name=15k_second_zero_roberta_pretrain_sc_cos_adamw \
    ...
    ++lightning_wrapper.sched_partial.secound_group_zero_epochs=15000 \
    ...
    datamodule.train_dataloader_cfg.num_workers=11 \
