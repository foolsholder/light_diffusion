python3 utils/generate_text_full.py experiments/commongen-baseline-lr5e-5-fixdataset-wopret-fixencs/step_40000.ckpt --ema --N 200
...
python3 utils/calculate_rouge.py generated_texts/ema_commongen-baseline-lr5e-5-fixdataset-wopret-fixencs/step_40000_200.json
