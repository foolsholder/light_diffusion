#python3 utils/generate_text_cfg.py experiments/wiki-pretrain-nam-noisy-067-bs512-t2/step_500000.ckpt --ema --count 128 --N 200 --w 1.0
...
#python3 utils/calculate_bloom_loss.py generated_texts/ema_wiki-pretrain-nam-noisy-067-bs512-t2/step_500000_200_cfg_0.0.json
python3 utils/calculate_roberta_metric.py generated_texts/ema_wiki-pretrain-nam-noisy-067-bs512-t2/step_500000_200_cfg_1.0.json
#python3 utils/calculate_div.py generated_texts/ema_wiki-pretrain-nam-noisy-067-bs512-t2/step_500000_200_cfg_0.0.json
