...
#python3 utils/validate.py experiments/cola_pretrained/61_0.5553.ckpt --ema
#python3 utils/validate.py experiments/cola_pretrained_roberta/320_0.5312.ckpt --ema
python3 utils/validate.py experiments/mrpc_pretrained_roberta_t5t/486_0.9257.ckpt --ema
