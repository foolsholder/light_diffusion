...
python3 utils/calculate_bloom_loss.py generated_texts/sc_adamw_cosine_sd/step_200000.json
...
#python3 utils/calculate_bloom_loss.py generated_texts/ema_roberta_pretrain_sc_cos_adamw/step_100000.json
#python3 utils/calculate_bloom_loss.py generated_texts/ema_roberta_pretrain_sc_cos_adamw/step_200000.json
#python3 utils/calculate_bloom_loss.py generated_texts/ema_roberta_pretrain_sc_cos_adamw/step_300000.json
#python3 utils/calculate_bloom_loss.py generated_texts/ema_roberta_pretrain_sc_cos_adamw/step_400000.json
