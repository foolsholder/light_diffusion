python3 utils/generate_text_check_ode.py experiments/wiki-pretrain-nam-noisy-067-bs512-t2/step_500000.ckpt --ema --count 8192 --N 1000
...
#python3 utils/calculate_bloom_loss.py generated_texts/ema_wiki-pretrain-nam-noisy-067-bs512-t2/step_500000_restore_ode_200.json
#python3 utils/calculate_roberta_metric.py generated_texts/ema_wiki-pretrain-nam-noisy-067-bs512-t2/step_500000_restore_ode_200.json
#python3 utils/calculate_div.py generated_texts/ema_wiki-pretrain-nam-noisy-067-bs512-t2/step_500000_restore_ode_200.json
