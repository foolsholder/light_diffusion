python3 utils/generate_text.py experiments/wiki-t5t-nam-noisy-067-bs512-t2/step_400000.ckpt --ema --count 8192 --N 200
...
python3 utils/calculate_bloom_loss.py generated_texts/ema_wiki-t5t-nam-noisy-067-bs512-t2/step_400000_200.json
