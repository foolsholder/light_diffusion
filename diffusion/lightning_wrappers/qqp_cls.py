...
class QQPFreezedClassification(GLUEFreezedClassification):
    def __init__(
        self,
        ...
        dropout = (
            bert_config.classifier_dropout if bert_config.classifier_dropout is not None \
    ...
    def forward(self, batch: Dict[str, Tensor]) -> Dict[str, Tensor]:
        ...
        pooler_output: Tensor = outs.pooler_output
        cls_logits = self.cls(pooler_output)
        return {
            "logits": cls_logits
        }
